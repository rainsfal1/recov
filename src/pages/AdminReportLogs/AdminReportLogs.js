...
export default function AdminReportLogs() {
    ...
    const fetchClaimData = async () => {
        ...
        const apiResponse = await fetch(`http://localhost:3000/api/v1/items/getItemsForAdmin/?page=${currentPage}`);
    ...
    return (_jsxs("div", { className: "container mx-auto px-4  md:px-6 md:py-12", children: [_jsx(LogsHeader, { title: "Report Logs", placeholder: "Search Report logs...", baseRoute: "/home/report-logs", selectedOption: null, setSelectedOption: () => { }, options: [] }), _jsx(Table, { data: claimData }), _jsx(Pagination, { currentPage: currentPage, totalPages: totalPages, onPageChange: () => setCurrentPage })] }));
}
